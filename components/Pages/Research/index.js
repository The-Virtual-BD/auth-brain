			...
			<div className="py-10 max-w-7xl mx-auto flex flex-col items-center px-6 lg:px-24 ">
				...
				<div className="my-10">
					<p>
						...
						sapiente assumenda exercitationem earum ducimus id impedit
						laudantium cupiditate? Nulla velit iusto quam tempora iste inventore
						ullam. Explicabo iure asperiores facere laboriosam sit illo ut dolor
						aliquam molestias? Accusantium sint reprehenderit, similique
						expedita delectus molestias iste beatae ratione dicta temporibus.
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit
						nobis consequuntur ex provident excepturi porro id expedita
						suscipit? Hic minus a vitae laudantium error ex suscipit ullam
						officiis quidem, dolore libero eligendi repellat quis fugiat
						doloremque, corrupti neque reprehenderit tempora in? Molestiae
						veritatis ea laboriosam itaque ab ipsa, vel accusantium.
					</p>
					...
					<p className="my-5">
						...
						officiis quidem, dolore libero eligendi repellat quis fugiat
						doloremque, corrupti neque reprehenderit tempora in? Molestiae
						veritatis ea laboriosam itaque ab ipsa, vel accusantium. Lorem ipsum

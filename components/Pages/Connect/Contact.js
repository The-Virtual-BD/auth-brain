...
const Contact = () => {
	return (
		<div className="">
			...
			<div className="p-10 max-w-7xl mx-auto flex items-center justify-between gap-10 px-6 lg:px-32">
				<div>
					<div className="text-start mt-14">
						<h3 className="text-greenclr mb-2 font-bold">Registered Address</h3>
						<p className="">

	...
	return (
		<div>
			...
			<div className="grid grid-cols-1 lg:grid-cols-3 gap-10 text-primary">
				<div className="w-full bg-white rounded-md  p-5 text-center">
					<div className="text-5xl flex items-center justify-center ">{feat1Icon}</div>
					<h2 className="text-2xl font-semibold my-5 text-greenclr">{feat1}</h2>
					<p>{feat1Desc}</p>
				</div>

				<div className="w-full bg-white  p-5 rounded-md  text-center">
					<div className="text-5xl flex items-center justify-center ">{feat2Icon}</div>
					<h2 className="text-2xl font-semibold my-5 text-greenclr">{feat2}</h2>
					<p>{feat2Desc}</p>
				</div>

				<div className="w-full bg-white  p-5 rounded-md  text-center">
					<div className="text-5xl flex items-center justify-center ">{feat3Icon}</div>
					<h2 className="text-2xl font-semibold my-5 text-greenclr">{feat3}</h2>
					<p>{feat3Desc}</p>
				</div>
			</div>
		</div>
